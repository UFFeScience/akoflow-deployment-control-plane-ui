...
export function Step5Review({ info, draft, tfDrafts, ansibleDrafts }: Props) {
  ...
  return (
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Implantação (Terraform)</p>
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Configuração (Ansible)</p>

...
export const providersApi = {
  ...
  createCredential: (organizationId: string, providerId: string, data: { name: string; slug: string; description?: string; is_active?: boolean; values: Record<string, string> }) =>
